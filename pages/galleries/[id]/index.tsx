            ...
            <div className='bg-mx-400 min-h-screen text-white'>
                ...
                <main className='container mx-auto'>
                    ...
                    <section className='flex justify-between items-center py-12 border-b border-white border-opacity-10'>
                        ...
                        <Link href='/galleries' className='group/arrow py-2 px-4 z-20 rounded font-bold bg-white text-mx-400 flex items-center gap-2'><i className="ri-arrow-left-line group-hover/arrow:-translate-x-1 duration-200"></i>View Albums</Link>
                    </section>
                    ...
                    {/* IMAGES */}
                    <section>
                        <div className="py-12 grid grid-cols-4 xl:grid-cols-6 gap-4">
                            {gallery?.url?.map((item: any, i: number) => {
                                return (
                                    <div className="w-full h-48 relative rounded-sm overflow-hidden cursor-pointer hover:scale-105 duration-200" key={i}>
                                        <Image
                                            alt='Image thumbnail'
                                            src={item} fill
